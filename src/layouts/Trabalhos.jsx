...
const images = [
  {
    src: "ensaio_masculino.jpg",
    alt: "Ensaio Masculino",
    tipo: "Pré-Missão",
    categoria: "gabriel",
  },
  {
    src: "ensaio_feminino.jpg",
    alt: "Ensaio Feminino",
    tipo: "Pré-Missão",
    categoria: "ensaio_pamella",
  },
  {
    src: "ensaio_masculino_2.jpg",
    alt: "Ensaio Masculino",
    tipo: "Pós-Missão",
    categoria: "ensaio_masculino2",
  },
  {
    src: "ensaio_feminino_2.jpg",
    alt: "Ensaio Feminino",
    tipo: "Pós-Missão",
    categoria: "ensaio_gomes",
  },
  {
    src: "ensaio_infantil.jpg",
    alt: "Ensaio Infantil",
    tipo: "Infantil",
    categoria: "infantil",
  },
  ...
  },
  {
    ...
    alt: "Pre wedding",
    tipo: "Casamento",
    categoria: "prewedding",
  },
  {
    src: "cerimonia_casamento.jpg",
...
export default function Trabalhos() {
  ...
  const imagensFiltradas =
    categoriaSelecionada === "todos"
      ? images
      : images.filter((image) =>
          categoriaMap[categoriaSelecionada]?.includes(image.categoria)
        );
      ...
      <div className={c.ContainerFotos}>
        {imagensFiltradas.map((image, index) => (
          <div
            key={index}
            className={c.foto}
            onClick={() => navigate(`/trabalhos/${image.categoria}`)}
          >
            <img src={image.src} alt={image.alt} />
            <span className={c.titulo}>
              {image.alt} | {image.tipo}
            </span>
          </div>
        ))}
      </div>
